...
<html>
<head>
<script charset="utf-8" src="<%= basePath %>/ojs/jquery.min.js?v=01291"></script>
<script charset="utf-8" src="<%= basePath %>/ojs/global.js?v=01291"></script>
<script charset="utf-8"
	src="<%= basePath %>/ojs/bootstrap.min.js?v=01291"></script>
<script charset="utf-8" src="<%= basePath %>/ojs/template.js?v=01291"></script>

<link rel="stylesheet" href="<%= basePath %>/ocss/bootstrap.css?v=01291">
<link rel="stylesheet" href="<%= basePath %>/ocss/style.css?v=1?v=01291">
<link rel="stylesheet" href="<%= basePath %>/ocss/member.css?v=01291">
<link rel="stylesheet" href="<%= basePath %>/ocss/order3.css?v=01291">
...
<title>产品详情</title>
<link rel="stylesheet"
	href="<%= basePath %>/css/productDetail.css?v=01291">
<script charset="utf-8" src="<%= basePath %>/js/TouchSlide.js?v=01291"></script>
					...
					<div
						...
						<ul
							...
							<!-- <div class="wap_page" style="display: none;"
								...
								<c:if test="${talkList == null || fn:length(talkList) <= 0}">
									<ul class="list-group">
										<li><p stye="color:black; text-align:center">目前没有评论过</p></li>
									</ul>
								</c:if>
								<c:forEach items="${talkList}" var="item" varStatus="status">
									<div class="tb_box">
										<div class="b_type clearfix">
											<a href="">
												<div class="hproduct clearfix"
													...
													<div class="p-pic">
														<img style="max-height: 100px; margin: 2 auto;"
															class="img-responsive" src="<%= basePath %>/images/picBg.jpg">
													</div>
													<div class="p-info">
														<p class="p-title">${item.userName}</p>
														<p class="p-origin">
															<span
																style="color: black; font-size: 10px">内容：</span>${item.talkMessage}
														</p>
														<p class="p-origin">
															<span style="color: black; font-size: 10px">${item.dateStr}</span>
														</p>
													</div>
