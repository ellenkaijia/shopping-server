        ...
        <div class="col-md-12 tal mt20">
            ...
            <input type="hidden" id="returnUrl" name="returnUrl" value="http://m.legendshop.cn/p/orderDetails"/>
              ...
              <div id="pwdInput">
	           ...
	           <div id="checkCodeInput" style="display:none">   
	             ...
	             <div class="clear"></div>
	         	 <label class="checkbox">
	                	 ...
	                	 <a style="float:right" onclick="changeLoginChannel()">切换登录方式</a> 
	              </label>
                <div class="clear"></div>
                <div class="col-xs-6 p0"><button type="button" class="btn btn-info btn-block" onclick="userLogin();"  tabindex="5" >登  陆</button></div>
                <div class="col-xs-5 p0" style="margin-left:10px;"><button type="button" class="btn btn-default btn-block" onclick="window.location.href='<%= basePath%>/register'"  tabindex="6" >注 册</button></div>
            </form>
        </div>
     </div>
	</div>
