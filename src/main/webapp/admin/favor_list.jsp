	...
	<div class="container" id="container2">
		<div class="row">
			...
			<div class="item-list" id="container" rel="2" status="0">
				...
				<c:forEach items="${favor}" var="item" varStatus="status">
					<a id="${item.prodId}"
					...
					<div class="hproduct clearfix"
						...
						<div class="p-info">
							...
							<a class="p-origin" style="float:right" onclick="deleteMyCollection('${item.prodId}')">
								<span style="color:red; font-size:15px">删除</span>
							</a>
						</div>
					</div>
				</a>
