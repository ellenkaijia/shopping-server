			...
			<div class="row">
				...
				<div class="list-group mb10 member_list_group clearfix">
					<a href="/p/collect" class="list-group-item col-xs-4">
						<div class="m_img">
							<img src="images/order_bg_5.png">
						</div>
						<p class="m_name">我的收藏</p> <span class="red">0</span>
					</a> <a href="/p/userComments" class="list-group-item col-xs-4">
						<div class="m_img">
							<img src="images/order_bg_8.png">
						</div>
						<p class="m_name">我的评论</p> <span class="red">&nbsp;&nbsp;</span>
					</a> <a href="/p/inbox" class="list-group-item col-xs-4">
						<div class="m_img">
							<img src="images/order_bg_4.png">
						</div>
						<p class="m_name">收件箱</p> <span class="red">&nbsp;&nbsp;</span>
					</a> <a href="/p/systemMessages" class="list-group-item col-xs-4">
						<div class="m_img">
							<img src="images/order_bg_7.png">
						</div>
				...
				<div class="list-group mb10">
					<a href="/p/help" class="list-group-item tip">
						<div class="list_group_img">
							<img src="images/order_bg_10.png">
						</div> 常见问题
					</a> <a href="/p/feedbacks" class="list-group-item tip">
						<div class="list_group_img">
							<img src="images/order_bg_9.png">
						</div> 意见反馈
					</a>
				</div>
